...
flag = 'WACon{aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa}'
assert len(flag) == 57
assert all(x in string.ascii_lowercase or x in string.digits for x in flag[6:-1]) # abcdefghijklmnopqrstuvwxyz0123456789 이것들 안에서 생김
